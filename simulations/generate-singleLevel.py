...
if __name__ == "__main__":
    ...
    parser.add_argument('sigma', help='total variance', type=float)
    ...
    config.set("k1",'sigma',str(args.theta1*args.sigma))
    config.set("k2",'sigma',str(args.sigma*(1-args.theta1)*args.theta2))
    config.set("yKernel",'sigma',str(args.sigma*(1-args.theta1)*(1-args.theta2)))

    label = '%d-%.1lf-%.1lf-%.1lf' % (args.p,args.sigma, args.theta1, args.theta2)
